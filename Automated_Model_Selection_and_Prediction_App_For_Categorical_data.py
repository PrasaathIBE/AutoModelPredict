...
if uploaded_file is not None:
    ...
    if st.button("Preprocess Data and Select Best Model"):
        ...
        st.write(f"Best Model Selected: {type(best_model).__name__} with Accuracy: {best_accuracy}")
    ...
    if 'predicted' in st.session_state and st.session_state.predicted:
        ...
        if st.button("Generate"):
            ...
            def plot_learning_rate_finder():
                st.write("Learning Rate Finder is typically used in deep learning frameworks.")

            def plot_cams():
                st.write("Class Activation Maps are typically used in CNNs with deep learning frameworks.")
            ...
            if graph_option == "Confusion Matrix":
                ...
                plot_error_analysis()
            elif graph_option == "Learning Rate Finder":
                plot_learning_rate_finder()
            elif graph_option == "CAMs":
                plot_cams()
